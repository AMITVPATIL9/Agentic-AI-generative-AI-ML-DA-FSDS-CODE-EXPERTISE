...
model = pickle.load(open(r'C:\Users\ammyg\Desktop\DATA SCIENCE\clasroom material\statistic_workshop_nit\my_practice\linear_regression_model1.pkl', 'rb'))
...
if st.button("Predict Salary"):
    ...
    # Display the result
    st.success(f"The predicted salary for {years_experience} years of experience is: ${predicted_salary:,.2f}")
   
# Display information about the model
st.write("The model was trained using a dataset of salaries and years of experience.built model by AMIT VP")
